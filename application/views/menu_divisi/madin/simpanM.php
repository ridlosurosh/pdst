                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group row mt-3">
                            ...
                            <input type="text" class="col-sm-9 form-control search_santri" name="search_santri" id="search_santri" placeholder="Nama Santri Madin" autocomplete="off">
