                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        ...
                        <div class="float-right">
                            <button type="button" onclick="kembali_lagi('<?= $santri->id_person ?>')" class="btn btn-primary active"><i class="fas fa-arrow-left"></i> Kembali</button>
                            <button class="btn btn-primary active" id="simpan">Simpan dan Lanjut <i class="fas fa-arrow-right"></i></button>
                            <button class="btn btn-primary active" id="simpan2">Simpan dan Lanjut <i class="fas fa-arrow-right"></i></button>
                        </div>
                    </div>
                </div>
            </form>
