<div class="container-fluid">
	<div class="page-header">
		<div class="row">
			<div class="col-lg-12">
				<h3>Data Mahrom Untuk Ananda <span class="text-danger"><?= $santri->nama ?></span></h3>
			</div>
		</div>
	</div>
</div>
	...
	<div class="card">
										...
										<ul class="list-inline">
											<li class="list-inline-item">
												<a class="item_upload" data="<?= $value->id_mahrom ?>" datanya="<?= $foto ?>" datan="<?= $ktp ?>">
													<img alt="Avatar" width="45" class="table-avatar" id="fotonya" title="FOTO DIRI" data="<?= $value->id_mahrom ?>" src="<?= site_url() ?><?= $foto ?>">
												</a>
											</li>
										</ul>
									</td>
		...
		<div class="card-footer">
			...
			<div class="float-right">
				...
				<button type="button" onclick="kembali_S('<?= $santri->id_person ?>')" class="btn btn-primary active"><i class="fas fa-arrow-left"></i> Kembali</button>
				<button type="button" class="btn btn-primary active" id="btn_selesai" onclick="selesai()"><i class="fas fa-check"></i> Selesai</button>
			</div>
			<script>
...
<div class="modal fade" id="ModalaAdd" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form class="form-horizontal" id="form_tambah_mahrom_2">
				...
				<div class="modal-footer justify-content-between">
					...
					<button class="btn btn-primary active" id="btn_simpan"><i class="fas fa-save"></i> Simpan</button>
				</div>
			</form>
		</div>
	</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form class="form-horizontal" id="form_edit_mahrom">
				...
				<div class="modal-footer justify-content-between">
					<button type="button" class="btn btn-default" data-dismiss="modal" aria-hidden="true">Tutup</button>
					<button class="btn btn-primary active" id="btn_edit"><i class="fas fa-edit"></i> Edit</button>
				</div>
			</form>
		</div>
	</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form class="form-horizontal" id="form_upload">
				...
				<div class="modal-footer justify-content-between">
					<button type="button" class="btn btn-default" data-dismiss="modal" aria-hidden="true">Tutup</button>
					<button class="btn btn-primary active"><i class="fas fa-arrow-up"></i> Upload</button>
				</div>
			</form>
		</div>
	</div>
...
<script>
	function form_tambah_mahrom_2(id) {
		...
		$('#form_tambah_mahrom_2').validate({
			...
			submitHandler: function() {
				$.ajax({
					...
					data: $('#form_tambah_mahrom_2').serialize(),
					type: 'POST',
					dataType: 'JSON',
					success: function(data) {
						if (data.pesan === "ya") {
							...
							swal.fire({
								...
								if (okay) {
									form_tambah_mahrom_2('<?= $santri->id_person ?>')
								}
							})
						} else {
							swal.fire({
