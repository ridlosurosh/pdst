...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            <a class="btn btn-sm btn-primary active" href="#" data-toggle="modal" data-target="#modal-default"><i class="fas fa-plus"></i> Tambah</a>
            <div class="card mt-2">
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                foreach ($periode as $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $value->periode ?></td>
                                        <td>
                                            <button class="btn btn-sm btn-primary active rounded-circle" onclick="lihat_jabatan('<?= $value->id_periode ?>')" title="Atur Struktur"><i class="fas fa-cog"></i></button>
